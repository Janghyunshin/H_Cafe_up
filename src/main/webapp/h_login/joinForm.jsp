		...
		<form action="join.do" method = "post">
			...
			<div class="int_area">
				<label for="member_pw">비밀번호</label>
	          	<input name="member_pw" type="password" required="required" placeholder="8~16자 숫자,문자,특수문자를 사용한 비밀번호" />
	        </div>
	        <div class="int_area">
	      		<label for="member_name">이름</label>
	          	<input type="text" name="member_name" required="required" placeholder="이름을 입력해 주세요" />
	        </div>
	        <div class="int_area">
	      		<label for="member_age">나이</label>
				<input type="number" name="member_age" required="required" min="0" placeholder="나이를 입력해 주세요"/>
	        </div>
	        <div class="int_area">
	     		<label for="member_address">주소</label>
	          	<input name="member_address" type="text" required="required" placeholder="주소를 입력해주세요" >
	        </div>
	        <div class="int_area">
	      		<label for="member_tel">전화번호</label>
	          	<input name="member_tel" type="text" required="required" 
	          	placeholder="휴대폰 번호를 '-' 표시없이 입력해 주세요." >
	        </div>
			<tr>
